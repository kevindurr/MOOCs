...
def to_dictionaries(nation_list):
    ...
    for nation in nation_list:
        myDict[nation.short_name] = {"long_name": nation.long_name, "iso_code": nation.iso_code, "iso_short": nation.iso_short, "iso_long": nation.iso_long, "capital": nation.capital}
    return myDict
